...
public class MainGlassfish {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("------using port: " + webPort);
        ...
        if (null != dbUrl) {
            ...
            properties = "user=" + prop.getProperty("user") + ":password=" + prop.getProperty("password") +
                    ":databasename=" + prop.getProperty("database") + ":loglevel=4:servername=" + prop.getProperty("host");
        }
